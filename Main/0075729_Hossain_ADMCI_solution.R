...
#*___________________________________________Necessary Functions______________________________________________*#
...
#*_______________________________________________Training Models______________________________________________*#
...
#*_______________________________________________Prediction Models____________________________________________*#
...
#*______________________________________________Computing Scores______________________________________________*#
...
#*__________________________________________________End of Functions__________________________________________*#
...
#*______________________________________________Data Pre-processing___________________________________________*#
...
#boruta_reduced_train_data <- cbind(train_predictors_boruta, train_labels)
#names(boruta_reduced_train_data)[ncol(boruta_reduced_train_data)] <- "Label"
...
#*_______________________________________________Train Models_________________________________________________*#
...
#*__________________________________Prediction Result and File Import_________________________________________*#
...
# Prediction of the test data using best classification model
...
write.csv(best_test_result_with_prob, file = "0075729_Hossain_ADMCIres", row.names = FALSE)
...
write.csv(best_predictor_selction_model, file = "0075729_Hossain_ADMCIfeat", row.names = FALSE)

#*__________________________________________End of the Project_______________________________________________*#
#*___________________________________________ Md Imran Hossain_______________________________________________*#